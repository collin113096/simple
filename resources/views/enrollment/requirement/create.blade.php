                   ...
                   <div class="row mb-5">
                    ...
                    <div class="row align-items-baseline">
                        <div class="col-md-2">
                            ...
                            <img class="d-block mx-auto mb-3" src="{{ asset('images/disable_document.png') }}" alt="" id="birth_certificate_tag" width="100px">
                              Birth Certificate
                            </label>
                        ...
                        <div class="col-md-2">
                            ...
                            <img class="d-block mx-auto mb-3" src="{{ asset('images/disable_document.png') }}" alt="" id="certificate_of_transfer_tag" width="100px">
                        ...
                        <div class="col-md-2">
                            ...
                            <img class="d-block mx-auto mb-3" src="{{ asset('images/disable_document.png') }}" alt="" id="certificate_of_good_moral_character_tag" width="100px">
                        ...
                        <div class="col-md-2">
                            ...
                            <img class="d-block mx-auto mb-3" src="{{ asset('images/disable_document.png') }}" alt="" id="form137_tag" width="100px">
                         ...
                         <div class="col-md-2">
                            ...
                            <img class="d-block mx-auto mb-3" src="{{ asset('images/disable_document.png') }}" alt="" id="form138_tag" width="100px">
                         ...
                         <div class="col-md-2">
                            ...
                            <img class="d-block mx-auto mb-3" src="{{ asset('images/disable_document.png') }}" alt="" id="picture_tag" width="100px">
                              Picture
                            </label>
...
<input id="asset" type="hidden" value="{{ asset('images/') }}"">
